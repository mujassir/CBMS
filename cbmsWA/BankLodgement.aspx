<%@ Page Title="" Language="C#" MasterPageFile="~/cbs.master" AutoEventWireup="true" CodeBehind="BankLodgement.aspx.cs" Inherits="cbmsWA.BankLodgement" %>
...
<fieldset class="lg">
<legend>Bank Lodgement</legend><br />
    ...
    **************** Peter *************
  <%--  <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankLodgement.aspx.cs" Inherits="forex.BankLodgement" EnableEventValidation="false"%>
...
<%--                <div class="sidenav h-100">
                ...
                <div class="contents flex-grow-1">
                            <div class="miniheader">
                                <hr/>
                                  <center><h4><span class="badge badge-primary"style="background:#183153;font-family:serif;margin-top:8px">BANK LODGEMENTS</span></h4></center>
                                 ...
                                 <div class="input-group-prepend">
                                    ...
                                    <asp:TextBox ID="TexBEDts" runat="server" tabindex="4" autocomplete="off" cssclass="form-control" style="text-transform:uppercase" aria-label="With textarea"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="TextBPDT" runat="server" type="hidden"></asp:TextBox>
                                             ...
                                             <asp:TextBox ID="TextBusiesType" runat="server" type="hidden" value="4"></asp:TextBox>
                                        </div>
                                        </div>
                                    </div>
