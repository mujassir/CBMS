                                ...
                                <div class="logo-fleft">
                                    ...
                                    <div class="site-logo site-logo__header">
                                        <a class="site-logo_link">
                                            <img runat="server" class="site-logo_img" src="images/vra1.jpg" alt="" />
                                        </a>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <div id="com-form-login-password">
                                                                        ...
                                                                        <asp:textbox id="password" cssclass="form-control inputbox" textmode="Password" runat="server"></asp:textbox>
