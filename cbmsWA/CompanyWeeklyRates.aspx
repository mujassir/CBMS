<%@ Page Title="" Language="C#" MasterPageFile="~/cbs.master" AutoEventWireup="true" CodeBehind="CompanyWeeklyRates.aspx.cs" Inherits="cbmsWA.CompanyWeeklyRates" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:Label runat="server" ID="result" ForeColor="Red" Font-Bold="true" ></asp:Label>
        ...
        <legend>Company - Weekly Rates</legend>
