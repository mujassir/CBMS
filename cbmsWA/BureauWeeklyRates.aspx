<%@ Page Title="" Language="C#" MasterPageFile="~/cbs.master" AutoEventWireup="true" CodeBehind="BureauWeeklyRates.aspx.cs" Inherits="cbmsWA.BureauWeeklyRates" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:Label runat="server" ID="result" ForeColor="Red" Font-Bold="true" ></asp:Label>
        ...
        <legend>Bureau - Weekly Rates</legend>
