<%@ Page Title="" Language="C#" MasterPageFile="~/cbs.master" AutoEventWireup="true" CodeBehind="CashInjection.aspx.cs" Inherits="cbmsWA.CashInjection" %>
...
<%--<asp:panel id="pnl" runat="server">
   --%>
<fieldset class="lg">
<legend>Cah Injection</legend><br />
<%--    **************** Peter *************--%>
<%--    <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashInjection.aspx.cs" Inherits="forex.CashInjection" EnableEventValidation="false"%>
...
<%--                                 <center><h4><span class="badge badge-primary"style="background:#183153;font-family:serif;margin-top:8px">Directors Cash Injections</span></h4></center>
                                ...
                                <div class="container" >
                                 ...
                                 <div class="input-group-prepend">
                                    <span class="input-group-text lo" style="width:150px;font-weight:bold">Date</span>
                                                   </div>
                                     <asp:TextBox ID="TexBPD" runat="server" cssclass="form-control put" tabindex="1" aria-describedby="inputGroup-sizing-sm"></asp:TextBox>
                                 </div>

                                                  <div class="input-group input-group-sm mb-3 input">
                                 <div class="input-group-prepend">
                                    <span class="input-group-text" style="width:150px;font-weight:bold">TransactionNo</span>
                                                   </div>
                                   <asp:TextBox ID="TexBRn" runat="server" ReadOnly="true" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" cssclass="form-control put" aria-describedby="inputGroup-sizing-sm"></asp:TextBox>
                                         ...
                                         <div class="input-group input-group-sm mb-3 input">
                                 <div class="input-group-prepend">
                                    <span class="input-group-text lo" style="width:150px;font-weight:bold">Currency</span>
                                                   </div>
                                 ...
                                 <div class="input-group input-group-sm mb-3 input">
                                 <div class="input-group-prepend">
                                    <span class="input-group-text lo" style="width:150px;font-weight:bold">Amount</span>
                                                   </div>
                                  <asp:TextBox ID="TexBoxEXAmot" runat="server" tabindex="3" onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))" autocomplete="off" cssclass="form-control put"  aria-describedby="inputGroup-sizing-sm"></asp:TextBox>
                                          ...
                                          <asp:TextBox ID="TextBSDT" runat="server" type="hidden"></asp:TextBox>
                                             ...
                                             <asp:TextBox ID="TextBCashIn" runat="server" type="hidden"></asp:TextBox>
                                             <asp:TextBox ID="TextBusiesType" runat="server" type="hidden" value="7"></asp:TextBox>

                                        <div class="col-sm-6 float-right">
                                           
                                      <div class="input-group input-group-sm mb-3 input">
                                 <div class="input-group-prepend">
                                    <span class="input-group-text lo" style="width:150px;font-weight:bold">Purchase Rate</span>
                                                   </div>
                                     <asp:TextBox ID="TexBPR" runat="server" ReadOnly="true" onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))" autocomplete="off" onblur="CashInMaths()"  CssClass ="form-control put"  aria-describedby="inputGroup-sizing-sm"></asp:TextBox>
                                       </div>
                                            
                                      <div class="input-group input-group-sm mb-3 input">
                                 <div class="input-group-prepend">
                                    <span class="input-group-text" style="width:150px;font-weight:bold">Cedi Equivalent</span>
                                                   </div>
                                       <asp:TextBox ID="TeBSAFS" runat="server" ReadOnly="true" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" cssclass="form-control put"  aria-describedby="inputGroup-sizing-sm"></asp:TextBox>
                                        ...
                                        <div class="input-group input-group-sm mb-3 input">
                                 <div class="input-group-prepend">
                                    <span class="input-group-text" style="width:150px;font-weight:bold">Available Total</span>
                                                   </div>
                                       <asp:TextBox ID="TextBCBalance" runat="server" ReadOnly="true" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" cssclass="form-control put"  aria-describedby="inputGroup-sizing-sm"></asp:TextBox>
                                              ...
                                              <div class="input-group input-group-sm mb-3 input">
                                 <div class="input-group-prepend">
                                    <span class="input-group-text lo" style="width:150px;font-weight:bold">Remarks</span>
                                                   </div>
                                    <asp:TextBox ID="TexBSIDNo" runat="server"  tabindex="4" autocomplete="off" cssclass="form-control put" style="text-transform:uppercase" aria-describedby="inputGroup-sizing-sm"></asp:TextBox>
                                         </div>
                                        </div>
                                        </div>
                                    </div>
   ...
   <%--</div>--%> <%--wrapper--%>
    ...
    <script src="assets/plugins/fontawesome/js/fontawesome.js"></script>
        ...
        <script src="CashInject.js"></script>
