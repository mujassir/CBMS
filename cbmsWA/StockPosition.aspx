<%@ Page Title="" Language="C#" MasterPageFile="~/cbs.master" AutoEventWireup="true" CodeBehind="StockPosition.aspx.cs" Inherits="cbmsWA.StockPosition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:Label runat="server" ID="result" ForeColor="Red" Font-Bold="true" ></asp:Label>
        ...
        <legend>BOG - Stock Position</legend>
